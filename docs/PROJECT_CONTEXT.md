...
本專案目前命名為「課程招生 - 系統」。目前 repo 已包含主要文件、LINE AI Cloudflare Worker 參考實作與可重跑 Node 測試，但正式前台、後台、資料庫與部署流水線仍未完成。

目前工作方向是建立一套支援「課程招生」從網頁表單收件、資料庫建檔、樣板提案、預覽通知到正式頁製作的系統。2026-05-27 最新決策是：LINE AI 不再負責逐步收資料，而是改為課程招生頁系統接待助理，導向客戶填寫網頁表單。
