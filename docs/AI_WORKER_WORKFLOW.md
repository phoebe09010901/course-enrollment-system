...
- 若 run log 出現不存在或非 configured cwd 的 worktree，例如 `/Users/phoebe/.codex/worktrees/4d27/課程招生 - 系統` 或 `/Users/phoebe/.codex/worktrees/1210/課程招生 - 系統`，應視為 stale worktree drift。
