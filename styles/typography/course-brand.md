...
--cb-text-section: clamp(2rem, 3.2vw, 2.75rem);
--cb-text-hero: clamp(2.625rem, 6.4vw, 4.75rem);
...
- Preferred length: 2 to 8 Chinese characters, or 2 to 4 English words.
...
<section class="cb-section cb-section--feature">
  <div class="cb-shell">
    <p class="cb-kicker">Method</p>
    <h2 class="cb-section-title">A clear course framework</h2>
    <p class="cb-body">Explain the method in calm, readable language.</p>
  </div>
</section>
```
